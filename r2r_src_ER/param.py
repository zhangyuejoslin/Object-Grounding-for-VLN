...
class Param:
    def __init__(self):
        ...
        #1. 37800
        #self.parser.add_argument("--load", type=str, default='/egr/research-hlr/joslin/Matterdata/v1/scans/checkpoints/agent/state_dict/20210703-193418/best_val_seen')
        ...
        self.parser.add_argument('--configpath', default="/home/joslin/R2R-EnvDrop/r2r_src1/components2_/configs/", type=str)
        ...
        self.parser.add_argument("--train_landmark_path", default='/home/joslin/R2R-EnvDrop/r2r_src1/components2_/landmarks/landmark_train.npy', type=str)
        self.parser.add_argument("--val_seen_landmark_path", default='/home/joslin/R2R-EnvDrop/r2r_src1/components2_/landmarks/landmark_val_seen.npy', type=str)
        self.parser.add_argument("--val_unseen_landmark_path", default='/home/joslin/R2R-EnvDrop/r2r_src1/components2_/landmarks/landmark_val_unseen.npy', type=str)
        ...
        self.parser.add_argument("--train_motion_indi_path", default='/home/joslin/R2R-EnvDrop/r2r_src1/components2_/motion_indicator/motion_indicator_train.npy', type=str)
        self.parser.add_argument("--val_seen_motion_indi_path", default='/home/joslin/R2R-EnvDrop/r2r_src1/components2_/motion_indicator/motion_indicator_val_seen.npy', type=str)
        self.parser.add_argument("--val_unseen_motion_indi_path", default='/home/joslin/R2R-EnvDrop/r2r_src1/components2_/motion_indicator/motion_indicator_val_unseen.npy', type=str)
