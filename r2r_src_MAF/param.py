...
class Param:
    def __init__(self):
        ...
        self.parser.add_argument('--configpath', default="/VL/space/zhan1624/obj-vln/r2r_src/components2/configs/", type=str)
        ...
        self.parser.add_argument("--obj_img_feat_path", default='/egr/research-hlr/joslin/Matterdata/v1/scans/img_features/mycsvfile_image_text.npy', type=str)
        self.parser.add_argument("--obj_text_feat_path", default='/egr/research-hlr/joslin/Matterdata/v1/scans/img_features/mycsvfile1.npy', type=str)

        self.parser.add_argument("--train_landmark_path", default='/VL/space/zhan1624/obj-vln/r2r_src/components4/landmarks/landmark_train.npy', type=str)
        self.parser.add_argument("--val_seen_landmark_path", default='/VL/space/zhan1624/obj-vln/r2r_src/components4/landmarks/landmark_val_seen.npy', type=str)
        self.parser.add_argument("--val_unseen_landmark_path", default='/VL/space/zhan1624/obj-vln/r2r_src/components4/landmarks/landmark_val_unseen.npy', type=str)
        ...
        self.parser.add_argument("--train_motion_indi_path", default='/VL/space/zhan1624/obj-vln/r2r_src/components2/motion_indicator/motion_indicator_train.npy', type=str)
        self.parser.add_argument("--val_seen_motion_indi_path", default='/VL/space/zhan1624/obj-vln/r2r_src/components2/motion_indicator/motion_indicator_val_seen.npy', type=str)
        self.parser.add_argument("--val_unseen_motion_indi_path", default='/VL/space/zhan1624/obj-vln/r2r_src/components2/motion_indicator/motion_indicator_val_unseen.npy', type=str)
